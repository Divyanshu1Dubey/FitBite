...
const Orders = () => {
  ...
  const [status, setStatus] = useState("all");
    ...
    useEffect(() => {
      document.title = "FitBite POS | Orders"
    }, [])
  ...
  return (
    <section className="bg-[#1f1f1f] min-h-[calc(100vh-5rem)] lg:h-[calc(100vh-5rem)] overflow-y-auto lg:overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3 px-4 sm:px-16 py-4 overflow-y-scroll scrollbar-hide">
        {isLoading ? (
